...
class View {
    ...
    public static function make($view, $content = array()) {
        ...
        try {
            ...
            if (method_exists('BaseController', 'get_kayttaja_logged_in')) {
                $content['user_logged_in'] = BaseController::get_kayttaja_logged_in();
            }

            if (method_exists('BaseController', 'get_yllapitaja_logged_in')) {
                $content['admin_logged_in'] = BaseController::get_yllapitaja_logged_in();
            }
